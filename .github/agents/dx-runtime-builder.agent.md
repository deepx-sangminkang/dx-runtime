...
- label: Build Standalone App
  agent: dx_app/.deepx/agents/dx-app-builder.md
  prompt: Route to dx_app for Python or C++ inference apps using SyncRunner/AsyncRunner and IFactory.
  send: false
- label: Build Pipeline App
  agent: dx_stream/.deepx/agents/dx-stream-builder.md
  prompt: Route to dx_stream for GStreamer pipeline apps using DxPreprocess, DxInfer, DxOsd elements.
  send: false
---

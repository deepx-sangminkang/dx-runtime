...
- label: Validate dx_app
  agent: dx_app/.deepx/agents/dx-validator.md
  prompt: Run validation and feedback loop for the dx_app sub-project.
  send: false
- label: Validate dx_stream
  agent: dx_stream/.deepx/agents/dx-validator.md
  prompt: Run validation and feedback loop for the dx_stream sub-project.
  send: false
---

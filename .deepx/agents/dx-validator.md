...
name: DX Validator
description: >
  Unified validation orchestrator for dx-runtime. Runs framework and app
  validation across dx_app and dx_stream, collects feedback, and applies
  approved fixes to the .deepx/ knowledge base.
